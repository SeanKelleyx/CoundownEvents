...
public class CountdownEventReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + CountdownEventReaderContract.CountdownEventEntry.TABLE_NAME + " (" +
                    ...
                    CountdownEventReaderContract.CountdownEventEntry.COLUMN_NAME_EVENT_DATETIME + INTEGER_TYPE + COMMA_SEP +
                    CountdownEventReaderContract.CountdownEventEntry.COLUMN_NAME_BACKGROUND_IMAGE + BLOB_TYPE +
                    " )";
